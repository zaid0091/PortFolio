...
function useCounter(target: number | string, duration = 1800, started = false) {
...
export default function About() {
  ...
  const [bioRef, bioVisible] = useInView<HTMLDivElement>();
  const [statsRef, statsVisible] = useInView<HTMLDivElement>();
  const [graphRef, graphVisible] = useInView<HTMLDivElement>();
    ...
    <section id="about" className="py-20" style={{ background: "var(--bg)" }}>
      <div className="max-w-[1100px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          >
            ...
            >
              ...
              <span
                ...
                style={{ background: "#ffd93d", padding: "1px 5px" }}
              >
              ...
              (2024–2028), building full-stack applications and REST APIs with a
            ...
            >
              ...
              <span
                className="highlight-cyan font-semibold"
                style={{
                  background: "#66d9ef",
                  padding: "1px 5px",
                  color: "var(--text)",
              ...
              I worked on production-level Django &amp; React projects and
              shipped features end-to-end — from database design to deployment
              on AWS &amp; Vercel.
            </p>
            <p
            ...
            >
              ...
              <span
                className="highlight-pink font-semibold"
                style={{
                  background: "#ff6b9d",
                  padding: "1px 5px",
                  color: "#000",
              ...
              <span
                className="highlight-green font-semibold"
                style={{
                  background: "#a8e6cf",
                  padding: "1px 5px",
                  color: "var(--text)",
          ...
          <div
            ref={statsRef}
            className={`grid grid-cols-2 gap-4 reveal ${statsVisible ? "is-visible" : ""}`}
          >
            {stats.map((s, i) => (
              <CounterCard
                key={i}
...
function CounterCard({ stat, suffix, started, delay }: CounterCardProps) {
