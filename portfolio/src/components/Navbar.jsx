          ...
          <ul className="hidden md:flex items-center gap-1 list-none">
            {links.map(l => (
              <li key={l.href}>
                <a
                  href={l.href}
                  className="nav-link text-[0.9rem] font-semibold px-[14px] py-[6px] border-2 border-transparent rounded hover:border-[var(--border)] transition-[background,border-color] duration-150"
        ...
        >
          {links.map(l => (
            <a
              key={l.href}
              href={l.href}
              className="mobile-link font-semibold px-[14px] py-[10px] border-2 rounded text-center transition-[background] duration-150"
