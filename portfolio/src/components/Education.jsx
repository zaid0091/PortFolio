...
export default function Education() {
  ...
  const [degreeRef, degreeVisible] = useInView();
    ...
    >
      <div className="max-w-[1100px] mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div
            ref={degreeRef}
            className={`neo-card p-6 reveal-left ${degreeVisible ? 'is-visible' : ''}`}
          >
          ...
          <div
            ref={certRef}
            className={`neo-card p-6 reveal-right ${certVisible ? 'is-visible' : ''}`}
          >
