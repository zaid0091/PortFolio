...
const supabaseUrl = process.env.VITE_SUPABASE_URL || 'https://hoojyvrabpoxjbkdsfvk.supabase.co'
const supabaseAnonKey = process.env.VITE_SUPABASE_ANON_KEY || 'sb_publishable_hVFg69N3vJbcMk5jjhEpiw_3kKfgXYR'
